...
/* harmony import */ var _magic_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./magic-button */ "./resources/js/magic-button.js");
/* harmony import */ var _magic_button__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_magic_button__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _magic_cursor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./magic-cursor */ "./resources/js/magic-cursor.js");
/* harmony import */ var _magic_cursor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_magic_cursor__WEBPACK_IMPORTED_MODULE_4__);
...
document.addEventListener('livewire:load', function () {
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('Main', function () {
    return {
      menu: false,
      init: function init() {
        ...
        this.$nextTick(function () {
          ...
          delSections.forEach(function (section) {
            var containerAnim = gsap.to(section.querySelector(".js-delayed-container"), {
              y: "100vh",
              ease: "none"
            });
            var imageAnim = gsap.to(section.querySelector(".js-delayed-img"), {
              y: "-100vh",
              ease: "none",
              paused: true
            });
            var scrub = gsap.to(imageAnim, {
              progress: 1,
              paused: true,
              ease: "power3",
        ...
        this.$watch('menu', function (value) {
          if (value) {
            ...
            (0,_utils__WEBPACK_IMPORTED_MODULE_2__.setupSplits)(document.querySelector('.js-menu'));
          } else {
...
window.getClipPath = _utils__WEBPACK_IMPORTED_MODULE_2__.getClipPath;
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start();
window.FastAverageColor = fast_average_color__WEBPACK_IMPORTED_MODULE_1__.FastAverageColor;

/***/ }),

/***/ "./resources/js/magic-button.js":
/*!**************************************!*\
  !*** ./resources/js/magic-button.js ***!
  \**************************************/
/***/ (() => {
...
document.addEventListener('alpine:init', function () {
  setTimeout(function () {
    var mWrap = document.querySelectorAll("[data-magic-button]");

    function parallaxIt(e, wrap) {
      var movement = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
...
var element = document.querySelector("[data-magic-cursor]");
...
var Cursor = /*#__PURE__*/function () {
  ...
  _createClass(Cursor, [{
    ...
    value: function move(e) {
      ...
      document.querySelectorAll("[data-magic-cursor-area]").forEach(function (single) {
...
/* harmony export */   "setupSplits": () => (/* binding */ setupSplits),
/* harmony export */   "wrapLines": () => (/* binding */ wrapLines)
/* harmony export */ });
...
function setupSplits() {
  ...
  var lines = container.querySelectorAll(".js-reveal-lines");
  lines.forEach(function (line) {
    var SplitTypeInstance = new SplitType(line, {
      types: 'lines'
    }); // wrap the lines (div with class .oh)
    // the inner child will be the one animating the transform

    wrapLines(SplitTypeInstance.lines, 'div', 'oh'); // Set up the anim

    line.anim = gsap.from(SplitTypeInstance.lines, {
      scrollTrigger: {
        trigger: line,
        // toggleActions: "restart pause resume reverse",
        start: "50% 97%" // markers: true,
  ...
  var els = container.querySelectorAll(".js-reveal-el");
...
function getClipPath(e) {
  ...
  return "circle(".concat(size, " at ").concat(xPercent, "% ").concat(yPercent, "%)");
}
